...
const List<String> gIncentiveOptions = [
  "Indie",
  "Las Vegas i dzikie okolice Światowego Centrum Rozrywki",
  "Malezja – Tropikalne Emocje",
  "Mauritius – Niebiańska Wyspa",
  "Rosja",
  "Tajlandia"
];

const String gIncentiveUrlLink = ""
    "http://www.4b.com.pl/uslugi/incentive/#tab1";

const String gIncentivePathToTopImage =
    "assets/images/offer/incentive/incentive_top_image.png";

const String gIncentivePathToMiddleImage =
