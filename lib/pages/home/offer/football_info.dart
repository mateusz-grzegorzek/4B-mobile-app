...
const List<String> gFootballOptions = [
  "Formuła 1",
  "Tenis",
  "NBA / HNL / NFL",
  "Boks",
...
const String gFootballUrlLink = ""
    "http://www.4b.com.pl/uslugi/wydarzenia-sportowe/#tab1";

const String gFootballPathToTopImage =
    "assets/images/offer/football/football_top_image.png";

const String gFootballPathToMiddleImage =
