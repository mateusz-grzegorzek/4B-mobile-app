import 'package:business_mobile_app/pages/trips/important_info/important_info_page.dart';
...
class ImportantInfoLasVegasWidget {
  ...
  List<Widget> fBuild() {
    return fBuildImportantInfoWidget(mExpansionTileKeyList, fBuildInfoTiles());
  }
}
